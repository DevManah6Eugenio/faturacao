...
func SelectUsuario(con *gorm.DB, filtroUser models.Usuario) (users []models.Usuario) {
...
func SelectUsuarioId(con *gorm.DB, id int64) (user models.Usuario) {
...
func InsertUsuario(con *gorm.DB, user *models.Usuario) {
	con.Create(&user)
...
func UpdateUsuario(con *gorm.DB, user *models.Usuario) {
...
func DeleteUsuario(con *gorm.DB, id int64) {
