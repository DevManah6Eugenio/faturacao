...
func SelectMateriaPrima(con *gorm.DB, filtroMateriaPrima models.MateriaPrima) (materiaPrimas []models.MateriaPrima) {
...
func SelectMateriaPrimaId(con *gorm.DB, id int64) (materiaPrima models.MateriaPrima) {
...
func InsertMateriaPrima(con *gorm.DB, materiaPrima *models.MateriaPrima) {
...
func UpdateMateriaPrima(con *gorm.DB, materiaPrima *models.MateriaPrima) {
...
func DeleteMateriaPrima(con *gorm.DB, id int64) {
