...
func SelectProduto(con *sql.DB, filtroProduto models.Produto) (produtos []models.Produto) {
...
func SelectProdutoId(con *sql.DB, id int64) (produto models.Produto) {
...
func InsertProduto(con *sql.DB, produto *models.Produto) {
...
func UpdateProduto(con *sql.DB, produto *models.Produto) {
...
func DeleteProduto(con *sql.DB, id int64) {
